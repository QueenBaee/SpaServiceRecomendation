...
class KukuController extends Controller
{
    public function index(){
        $kuku = Kuku::paginate(20);
        return view ('kuku.index', ['kuku'=> $kuku]);
    }
    public function create(){
        return view ('kuku.input');
    }
    public function insert(){
        return view ('kuku.create');
    }
public function store(Request $request)
{
    ...
    try {
        ...
        return redirect('/perawatanKuku')->with('success', 'Data berhasil disimpan!');
    } catch (\Exception $e) {
    ...
    public function edit($id){
        $kuku = Kuku::findOrFail($id);
        return view ('kuku.edit', compact('kuku'));
    }
    ...
    try {
        ...
        Log::info('Data berhasil diperbarui:', $kuku->toArray());

        // Redirect dengan pesan sukses
        return redirect('/perawatanKuku')->with('success', 'Data berhasil diperbarui!');
    } catch (\Exception $e) {
        // Log error
