...
<div class="page-header d-print-none">
        ...
        <div class="col-6 col-sm-4 col-md-2 col-xl bg-dark py-3">
                        <a href="/perawatanKuku/create" class="btn btn-light w-100">
...
<table class="table table-vcenter card-table table-striped">
                      ...
                      <tbody>
                        ...
                        <td>
                          <a href="{{ route('perawatanKuku.edit', $item->id) }}">Edit</a>
                          <a href="perawatanKuku/delete/{{ $item->id }}">Hapus</a>
                        </td>
                        </tr>
                        @endforeach
                      </tbody>
